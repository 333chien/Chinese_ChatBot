# -*- coding: utf-8 -*-
"""chatbot_inference_Attention.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/github/jayeew/Chinese-ChatBot/blob/master/chatbot_inference_Attention.ipynb
"""
...
text_msg.tag_config('tag_1',foreground = '#000000 ',background='black')
...
def show():
    ...
    seq, sentence = input_question(seq)
    answer = decode_greedy(seq, sentence)
    answer = cc.convert(answer)  #簡轉繁_Chien測試用
    print(answer)
    answer = ''.join(answer.split(' ')[:-1])
    msg_recv = '[小眼睛]: '+ answer + '\n'
    text_recv.insert(END, msg_recv)
    text_msg.delete("0.0", "end")
Button(root,text='送出',width=10,command=show, 
...
Button(root, text="清空",width=10,command = lambda : text_recv.delete(0.0, END),
       bd=0, bg='#00BFFF', fg='#FFFFFF',
