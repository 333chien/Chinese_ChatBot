...
Original file is located at
    https://colab.research.google.com/github/jayeew/Chinese-ChatBot/blob/master/get_data.ipynb
"""
...
np.save('test_question.npy', pad_question)
np.save('test_answer.npy', pad_answer)
